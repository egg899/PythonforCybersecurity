...
# By Alberto German Verissimo on April 12, 2022

#import necesary Python modules
import base64
...
# Using letter in variable, call the encode or decode function
if method[0] == 'e':
    print(encode_data(message))
elif method[0] == 'd':
    print(decode_data(message))  
else:
    #if method wasnt "e" ir "d", print error message and quit
